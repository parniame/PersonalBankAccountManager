...
namespace Persistence.Migrations
{
    ...
    [Migration("20241216155327_remove-secondbankAccountIdFK")]
    partial class removesecondbankAccountIdFK
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Models.Entities.Bank", b =>
                {
                    ...
                    b.Property<DateTime?>("DateCreated")
                        ...
                        .HasDefaultValue(new DateTime(2024, 12, 16, 19, 23, 27, 261, DateTimeKind.Local).AddTicks(5687));

                    b.Property<DateTime?>("DateUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 16, 19, 23, 27, 261, DateTimeKind.Local).AddTicks(5980));
            ...
            modelBuilder.Entity("Models.Entities.BankAccount", b =>
                {
                    ...
                    b.Property<DateTime?>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 16, 19, 23, 27, 261, DateTimeKind.Local).AddTicks(2031));

                    b.Property<DateTime?>("DateUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 16, 19, 23, 27, 261, DateTimeKind.Local).AddTicks(2360));
            ...
            modelBuilder.Entity("Models.Entities.Transaction", b =>
                {
                    ...
                    b.Property<DateTime?>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 16, 19, 23, 27, 263, DateTimeKind.Local).AddTicks(3251));

                    b.Property<DateTime?>("DateUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 16, 19, 23, 27, 263, DateTimeKind.Local).AddTicks(3592));
            ...
            modelBuilder.Entity("Models.Entities.TransactionCategory", b =>
                {
                    ...
                    b.Property<DateTime?>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 16, 19, 23, 27, 261, DateTimeKind.Local).AddTicks(7513));

                    b.Property<DateTime?>("DateUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 16, 19, 23, 27, 261, DateTimeKind.Local).AddTicks(7767));
            ...
            modelBuilder.Entity("Models.Entities.TransactionPlan", b =>
                {
                    ...
                    b.Property<DateTime?>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 16, 19, 23, 27, 265, DateTimeKind.Local).AddTicks(7722));

                    b.Property<DateTime?>("DateUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 16, 19, 23, 27, 265, DateTimeKind.Local).AddTicks(7985));
            ...
            modelBuilder.Entity("Models.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime?>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 12, 16, 19, 23, 27, 266, DateTimeKind.Local).AddTicks(748));

                    b.Property<DateTime?>("DateOfBirth")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 12, 16, 19, 23, 27, 266, DateTimeKind.Local).AddTicks(395));

                    b.Property<DateTime?>("DateUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 12, 16, 19, 23, 27, 266, DateTimeKind.Local).AddTicks(900));
