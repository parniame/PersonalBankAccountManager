...
namespace Persistence.Migrations
{
    ...
    [Migration("20241202195806_make-bank-with-pictureId")]
    partial class makebankwithpictureId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Models.Entities.Bank", b =>
                {
                    ...
                    b.Property<DateTime?>("DateCreated")
                        ...
                        .HasDefaultValue(new DateTime(2024, 12, 2, 23, 28, 6, 148, DateTimeKind.Local).AddTicks(9678));

                    b.Property<DateTime?>("DateUpdated")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 2, 23, 28, 6, 149, DateTimeKind.Local).AddTicks(83));
            ...
            modelBuilder.Entity("Models.Entities.BankAccount", b =>
                {
                    ...
                    b.Property<DateTime?>("DateCreated")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 2, 23, 28, 6, 148, DateTimeKind.Local).AddTicks(5752));

                    b.Property<DateTime?>("DateUpdated")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 2, 23, 28, 6, 148, DateTimeKind.Local).AddTicks(6200));
            ...
            modelBuilder.Entity("Models.Entities.Picture", b =>
                {
                    ...
                    b.Property<DateTime?>("DateCreated")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 2, 23, 28, 6, 149, DateTimeKind.Local).AddTicks(5128));

                    b.Property<DateTime?>("DateUpdated")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 2, 23, 28, 6, 149, DateTimeKind.Local).AddTicks(5452));
            ...
            modelBuilder.Entity("Models.Entities.Transaction", b =>
                {
                    ...
                    b.Property<DateTime?>("DateCreated")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 2, 23, 28, 6, 149, DateTimeKind.Local).AddTicks(8455));

                    b.Property<DateTime?>("DateUpdated")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 2, 23, 28, 6, 149, DateTimeKind.Local).AddTicks(8816));
            ...
            modelBuilder.Entity("Models.Entities.TransactionCategory", b =>
                {
                    ...
                    b.Property<DateTime?>("DateCreated")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 2, 23, 28, 6, 149, DateTimeKind.Local).AddTicks(1763));

                    b.Property<DateTime?>("DateUpdated")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 2, 23, 28, 6, 149, DateTimeKind.Local).AddTicks(2092));
            ...
            modelBuilder.Entity("Models.Entities.TransactionPlan", b =>
                {
                    ...
                    b.Property<DateTime?>("DateCreated")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 2, 23, 28, 6, 152, DateTimeKind.Local).AddTicks(7906));

                    b.Property<DateTime?>("DateUpdated")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 2, 23, 28, 6, 152, DateTimeKind.Local).AddTicks(8275));
            ...
            modelBuilder.Entity("Models.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime?>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 12, 2, 23, 28, 6, 153, DateTimeKind.Local).AddTicks(1324));

                    b.Property<DateTime?>("DateOfBirth")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 12, 2, 23, 28, 6, 153, DateTimeKind.Local).AddTicks(915));

                    b.Property<DateTime?>("DateUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 12, 2, 23, 28, 6, 153, DateTimeKind.Local).AddTicks(1521));
