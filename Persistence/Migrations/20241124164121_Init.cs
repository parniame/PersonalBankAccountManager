        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateCreated = table.Column<DateTime>(type: "DateTime", nullable: false, defaultValue: new DateTime(2024, 11, 24, 20, 11, 20, 880, DateTimeKind.Local).AddTicks(403)),
                    DateUpdated = table.Column<DateTime>(type: "DateTime", nullable: false, defaultValue: new DateTime(2024, 11, 24, 20, 11, 20, 880, DateTimeKind.Local).AddTicks(798))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOfBirth = table.Column<DateTime>(type: "datetime", nullable: true, defaultValue: new DateTime(2024, 11, 24, 20, 11, 20, 881, DateTimeKind.Local).AddTicks(9299)),
                    DateCreated = table.Column<DateTime>(type: "datetime", nullable: true, defaultValue: new DateTime(2024, 11, 24, 20, 11, 20, 881, DateTimeKind.Local).AddTicks(9707)),
                    CreatorID = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    DateUpdated = table.Column<DateTime>(type: "datetime", nullable: true, defaultValue: new DateTime(2024, 11, 24, 20, 11, 20, 881, DateTimeKind.Local).AddTicks(9905)),
