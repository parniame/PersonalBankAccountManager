...
namespace Persistence.Migrations
{
    ...
    [Migration("20241219163528_add-isPaid-to-transactionPlan")]
    partial class addisPaidtotransactionPlan
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Models.Entities.Bank", b =>
                {
                    ...
                    b.Property<DateTime?>("DateCreated")
                        ...
                        .HasDefaultValue(new DateTime(2024, 12, 19, 20, 5, 28, 87, DateTimeKind.Local).AddTicks(2197));

                    b.Property<DateTime?>("DateUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 19, 20, 5, 28, 87, DateTimeKind.Local).AddTicks(2546));
            ...
            modelBuilder.Entity("Models.Entities.BankAccount", b =>
                {
                    ...
                    b.Property<DateTime?>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 19, 20, 5, 28, 86, DateTimeKind.Local).AddTicks(8593));

                    b.Property<DateTime?>("DateUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 19, 20, 5, 28, 86, DateTimeKind.Local).AddTicks(8966));
            ...
            modelBuilder.Entity("Models.Entities.Transaction", b =>
                {
                    ...
                    b.Property<DateTime?>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 19, 20, 5, 28, 89, DateTimeKind.Local).AddTicks(907));

                    b.Property<DateTime?>("DateUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 19, 20, 5, 28, 89, DateTimeKind.Local).AddTicks(1276));
            ...
            modelBuilder.Entity("Models.Entities.TransactionCategory", b =>
                {
                    ...
                    b.Property<DateTime?>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 19, 20, 5, 28, 87, DateTimeKind.Local).AddTicks(4151));

                    b.Property<DateTime?>("DateUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 19, 20, 5, 28, 87, DateTimeKind.Local).AddTicks(4386));
            ...
            modelBuilder.Entity("Models.Entities.TransactionPlan", b =>
                {
                    ...
                    b.Property<DateTime?>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 19, 20, 5, 28, 89, DateTimeKind.Local).AddTicks(7855));

                    b.Property<DateTime?>("DateUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 19, 20, 5, 28, 89, DateTimeKind.Local).AddTicks(8145));
            ...
            modelBuilder.Entity("Models.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime?>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 12, 19, 20, 5, 28, 90, DateTimeKind.Local).AddTicks(1004));

                    b.Property<DateTime?>("DateOfBirth")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 12, 19, 20, 5, 28, 90, DateTimeKind.Local).AddTicks(615));

                    b.Property<DateTime?>("DateUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 12, 19, 20, 5, 28, 90, DateTimeKind.Local).AddTicks(1206));
