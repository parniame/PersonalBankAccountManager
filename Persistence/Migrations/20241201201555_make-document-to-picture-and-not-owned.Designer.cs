...
namespace Persistence.Migrations
{
    ...
    [Migration("20241201201555_make-document-to-picture-and-not-owned")]
    partial class makedocumenttopictureandnotowned
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Models.Entities.Bank", b =>
                {
                    ...
                    b.Property<DateTime?>("DateCreated")
                        ...
                        .HasDefaultValue(new DateTime(2024, 12, 1, 23, 45, 55, 353, DateTimeKind.Local).AddTicks(3291));

                    b.Property<DateTime?>("DateUpdated")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 1, 23, 45, 55, 353, DateTimeKind.Local).AddTicks(3688));
            ...
            modelBuilder.Entity("Models.Entities.BankAccount", b =>
                {
                    ...
                    b.Property<DateTime?>("DateCreated")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 1, 23, 45, 55, 352, DateTimeKind.Local).AddTicks(9227));

                    b.Property<DateTime?>("DateUpdated")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 1, 23, 45, 55, 352, DateTimeKind.Local).AddTicks(9621));
            ...
            modelBuilder.Entity("Models.Entities.Picture", b =>
                {
                    ...
                    b.Property<DateTime?>("DateCreated")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 1, 23, 45, 55, 353, DateTimeKind.Local).AddTicks(8922));

                    b.Property<DateTime?>("DateUpdated")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 1, 23, 45, 55, 353, DateTimeKind.Local).AddTicks(9414));
            ...
            modelBuilder.Entity("Models.Entities.Transaction", b =>
                {
                    ...
                    b.Property<DateTime?>("DateCreated")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 1, 23, 45, 55, 354, DateTimeKind.Local).AddTicks(2589));

                    b.Property<DateTime?>("DateUpdated")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 1, 23, 45, 55, 354, DateTimeKind.Local).AddTicks(2962));
            ...
            modelBuilder.Entity("Models.Entities.TransactionCategory", b =>
                {
                    ...
                    b.Property<DateTime?>("DateCreated")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 1, 23, 45, 55, 353, DateTimeKind.Local).AddTicks(5614));

                    b.Property<DateTime?>("DateUpdated")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 1, 23, 45, 55, 353, DateTimeKind.Local).AddTicks(5978));
            ...
            modelBuilder.Entity("Models.Entities.TransactionPlan", b =>
                {
                    ...
                    b.Property<DateTime?>("DateCreated")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 1, 23, 45, 55, 357, DateTimeKind.Local).AddTicks(1829));

                    b.Property<DateTime?>("DateUpdated")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 1, 23, 45, 55, 357, DateTimeKind.Local).AddTicks(2187));
            ...
            modelBuilder.Entity("Models.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime?>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 12, 1, 23, 45, 55, 357, DateTimeKind.Local).AddTicks(5527));

                    b.Property<DateTime?>("DateOfBirth")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 12, 1, 23, 45, 55, 357, DateTimeKind.Local).AddTicks(5101));

                    b.Property<DateTime?>("DateUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 12, 1, 23, 45, 55, 357, DateTimeKind.Local).AddTicks(5735));
