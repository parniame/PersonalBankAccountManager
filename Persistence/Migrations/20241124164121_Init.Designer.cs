            ...
            modelBuilder.Entity("Models.Entities.Bank", b =>
                {
                    ...
                    b.Property<DateTime?>("DateCreated")
                        ...
                        .HasDefaultValue(new DateTime(2024, 11, 24, 20, 11, 20, 880, DateTimeKind.Local).AddTicks(403));

                    b.Property<DateTime?>("DateUpdated")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 11, 24, 20, 11, 20, 880, DateTimeKind.Local).AddTicks(798));
            ...
            modelBuilder.Entity("Models.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime?>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 11, 24, 20, 11, 20, 881, DateTimeKind.Local).AddTicks(9707));

                    b.Property<DateTime?>("DateOfBirth")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 11, 24, 20, 11, 20, 881, DateTimeKind.Local).AddTicks(9299));

                    b.Property<DateTime?>("DateUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 11, 24, 20, 11, 20, 881, DateTimeKind.Local).AddTicks(9905));
