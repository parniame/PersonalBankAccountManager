...
namespace Persistence.Migrations
{
    ...
    [Migration("20241217175556_make-transactionDocument-one-to-one")]
    partial class maketransactionDocumentonetoone
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Models.Entities.Bank", b =>
                {
                    ...
                    b.Property<DateTime?>("DateCreated")
                        ...
                        .HasDefaultValue(new DateTime(2024, 12, 17, 21, 25, 55, 807, DateTimeKind.Local).AddTicks(862));

                    b.Property<DateTime?>("DateUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 17, 21, 25, 55, 807, DateTimeKind.Local).AddTicks(1264));
            ...
            modelBuilder.Entity("Models.Entities.BankAccount", b =>
                {
                    ...
                    b.Property<DateTime?>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 17, 21, 25, 55, 806, DateTimeKind.Local).AddTicks(6813));

                    b.Property<DateTime?>("DateUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 17, 21, 25, 55, 806, DateTimeKind.Local).AddTicks(7205));
            ...
            modelBuilder.Entity("Models.Entities.Transaction", b =>
                {
                    ...
                    b.Property<DateTime?>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 17, 21, 25, 55, 809, DateTimeKind.Local).AddTicks(1027));

                    b.Property<DateTime?>("DateUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 17, 21, 25, 55, 809, DateTimeKind.Local).AddTicks(1413));
            ...
            modelBuilder.Entity("Models.Entities.TransactionCategory", b =>
                {
                    ...
                    b.Property<DateTime?>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 17, 21, 25, 55, 807, DateTimeKind.Local).AddTicks(2897));

                    b.Property<DateTime?>("DateUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 17, 21, 25, 55, 807, DateTimeKind.Local).AddTicks(3178));
            ...
            modelBuilder.Entity("Models.Entities.TransactionPlan", b =>
                {
                    ...
                    b.Property<DateTime?>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 17, 21, 25, 55, 809, DateTimeKind.Local).AddTicks(8867));

                    b.Property<DateTime?>("DateUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("DateTime")
                        .HasDefaultValue(new DateTime(2024, 12, 17, 21, 25, 55, 809, DateTimeKind.Local).AddTicks(9215));
            ...
            modelBuilder.Entity("Models.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime?>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 12, 17, 21, 25, 55, 810, DateTimeKind.Local).AddTicks(2299));

                    b.Property<DateTime?>("DateOfBirth")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 12, 17, 21, 25, 55, 810, DateTimeKind.Local).AddTicks(1905));

                    b.Property<DateTime?>("DateUpdated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2024, 12, 17, 21, 25, 55, 810, DateTimeKind.Local).AddTicks(2538));
